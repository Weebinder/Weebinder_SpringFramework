...
INSERT INTO sample VALUES (DEFAULT, '신수민');
INSERT INTO sample VALUES (DEFAULT, '오태훈');
INSERT INTO sample VALUES (DEFAULT, '김태균');
INSERT INTO sample VALUES (DEFAULT, '김어은');
INSERT INTO sample VALUES (DEFAULT, '피여라');
INSERT INTO sample VALUES (DEFAULT, '이승호');
INSERT INTO sample VALUES (DEFAULT, '한소율');
...
INSERT INTO member VALUES ('admin', '1234', '관리자',
                           'admin@weebinder.co.kr', '0212341234',
                           '서울특별시 금천구 디지털로9길 23 (마리오2 패션타워)',
                           '11층 1108호', '08511', DEFAULT, '2023-12-25',
                           DEFAULT, DEFAULT);
INSERT INTO member VALUES ('dhxogns920', '4321', '오태훈',
                           'dhxogns920@weebinder.co.kr', '0107329-7484',
                           '서울특별시 금천구 가산로9길 54',
...
UPDATE member SET pw='$2a$10$mpr36CRQpp903gPf.f76auK1CYzFkq.LD65JsGzdrBCiOluBotWYW' WHERE id='dhxogns920';
SELECT * FROM member;